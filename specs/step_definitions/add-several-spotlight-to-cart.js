...
Given('that I have searched for the item tall and bright {string}', (a) => {
  searchedFor = a;
  cy.get('#search').type(a);
});

When('I click the buy button this {string} amount of times', (quantity) => {
...
Then('{string} {string} should be added to my cart so it can light up my life', (quantity, a) => {
  cy.get('#cart li')
    .contains(a)
