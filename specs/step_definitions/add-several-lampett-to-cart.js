...
Given('that I have searched for the tall item {string}', (a) => {
  searchedFor = a;
  cy.get('#search').type(a);
});

When('I click the button to buy this {string} amount of times', (quantity) => {
...
Then('{string} {string} should be added to my shopping cart', (quantity, a) => {
  cy.get('#cart li')
    .contains(a)
