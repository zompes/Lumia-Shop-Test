...
Given('that I have searched for the item {string} that hangs above', (a) => {
  searchedFor = a;
  cy.get('#search').type(a);
});

When('I click the buy button {string} times because I got the money', (quantity) => {
...
Then('{string} {string} should be added to my cart so that my house will be bright', (quantity, a) => {
  cy.get('#cart li')
    .contains(a)
